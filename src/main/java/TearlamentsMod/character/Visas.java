...
public class Visas extends CustomPlayer {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        // Test Starter Deck
//        retVal.add(MannadiumMeek.ID);
//        retVal.add(MannadiumFearless.ID);
//        retVal.add(MannadiumTorrid.ID);
//        retVal.add(MannadiumImaginings.ID);
//        retVal.add(MannadiumAbscission.ID);
//        retVal.add(MannadiumReframing.ID);
...
//        retVal.add(TearlamentMerrli.ID);
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel(imagePath("ending/EndingSlice_1.png")));
        panels.add(new CutscenePanel(imagePath("ending/EndingSlice_2.png")));
        panels.add(new CutscenePanel(imagePath("ending/EndingSlice_3.png")));
        return panels;
    }
