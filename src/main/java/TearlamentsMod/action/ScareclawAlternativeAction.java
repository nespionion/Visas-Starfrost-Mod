...
public class ScareclawAlternativeAction extends AbstractGameAction {
    ...
    public ScareclawAlternativeAction(CardGroup destination) {
    ...
    public ScareclawAlternativeAction(CardGroup destination, HashSet<AbstractCard> exceptions) {
        this.p = AbstractDungeon.player;
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = this.startDuration = Settings.ACTION_DUR_FAST;
        this.replacement = null;
...
//            }
    ...
    private AbstractCard getAlternativeEvolution(EvolvingCard c){
        ...
        if (c instanceof TearlamentKitkallos) {
            evolution = new MannadiumTrisukta();
        } else if (c instanceof TearlamentKashtira) {
            evolution = new TearlamentKitkallos();
        } else if (c instanceof ScareclawKashtira) {
            evolution = new ScareclawTriHeart();
        } else if (c.hasTag(CustomTags.SCARECLAW) && c.hasTag(CustomTags.CREATURE)) {
            evolution = new ScareclawLightHeart();
        } else {
