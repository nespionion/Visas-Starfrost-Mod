...
import TearlamentsMod.action.ScareclawAlternativeAction;
...
public class ScareclawAlternative extends BaseCard {
    public static final String ID = makeID(ScareclawAlternative.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ScareclawAlternativeAction(p.hand));
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new ScareclawAlternative();
    }
}
