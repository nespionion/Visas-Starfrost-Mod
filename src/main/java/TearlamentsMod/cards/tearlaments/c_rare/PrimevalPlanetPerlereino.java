...
public class PrimevalPlanetPerlereino extends BaseCard {
    public static final String ID = makeID(PrimevalPlanetPerlereino.class.getSimpleName());
    ...
    public PrimevalPlanetPerlereino() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new PerlereinoPower(p, 1)));
    }
}
