...
public class FearlessOrb extends CustomOrb {
    ...
    public FearlessOrb() {
        this(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[0], DESCRIPTIONS[1], VisasMod.orbPath(FearlessOrb.class.getSimpleName() + ".png"));
        VisasMod.logger.info("Orb path: " + VisasMod.orbPath(ORB_ID + ".png"));
